 ...
 */
const FIXTURE = resolve(import.meta.dirname, '../../model/test/fixtures/marcowki-ge-1.5.0.json')
...
describe('Marcówki persistence', () => {
  ...
  it('equals the frozen fixture packages/model/test/fixtures/marcowki-ge-1.5.0.json', () => {
