...
item('T2-FRAME-001', 'FRAME', 'coordinate frame of this truth set', ['gp', 'sec'], [L('gp', 'plan orientation: the 105/210 entrance and the 275/225 garage door callouts sit along the bottom edge (rows 745..760), so the FRONT is at the bottom of the sheet')],
     ...
     {}, 'SOURCE_DERIVED', 'convention stated once; every other item is in this frame', 'the current Marcówki Auto puts the FRONT WALL at z=0 and its zone at z -1..0; this set puts the outermost front plane at z=0 as the reference model does (z_v2 = z_auto + 1.00)')
