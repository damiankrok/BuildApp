| | bytes | MiB |
| --- | ---: | ---: |
| APK without the local analyzer (app-x86_64-debug.apk, -PlocalAnalyzer=false) | 12,032,464 | 11.48 |
| APK with the local analyzer (app-x86_64-debug.apk) | 31,822,048 | 30.35 |
